...
//kmm
        final String LEAGUE_395 = "395";
        final String LEAGUE_397 = "397";
        final String LEAGUE_398 = "398";
        final String LEAGUE_403 = "403";
//kmm
        ...
        try {
            ...
            for(int i = 0;i < matches.length();i++)
            {
                ...
                Log.d(LOG_TAG, "processJSONdata League = " +League);
                ...
                if(     League.equals(PREMIER_LEGAUE)      ||
                        ...
                        League.equals(LEAGUE_395)          ||
                        League.equals(LEAGUE_397)          ||
                        League.equals(LEAGUE_398)          ||
                        League.equals(LEAGUE_403)          )
                {
                    ...
                    Log.d(LOG_TAG, "matchID="+match_id +" Date="+mDate + " Home=" +Home + " Away=" +Away);
